...
| 조아름 | |
| 정재훈 | |
| 정석원 | 데이터에 대한 분석을 하기 위해 다양한 논문과 자료를 검색하며 개요 및 근거를 단단히 하였고,  많은 방대한 양의 데이터셋으로 인해 모델학습을 진행을 하면서 하드웨어적인 한계점으로 인해 학습시간이 딜레이 되는 점이 아쉬웠다. 해당 문제를 해결하기 위해 다양한 시도를 해보며 실력을 더 늘릴 수 있었다. |
